        ...
        {skillsData.map((skill, idx) => (
          ...
          >
            ...
            <img
              src={skill.image}
              alt={skill.title}
              className="w-14 h-14 sm:w-16 sm:h-16 transition-transform duration-500 ease-in-out group-hover:rotate-[360deg]"
            />

            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-300 z-10 pointer-events-none">
